...
--
-- Servidor: localhost
-- Tiempo de generación: 13-06-2017 a las 22:22:36
...
--
-- Estructura de tabla para la tabla `batch_history`
--
...
--
-- Volcar la base de datos para la tabla `batch_history`
--
...
--
-- Estructura de tabla para la tabla `billing_merchant`
--
...
--
-- Volcar la base de datos para la tabla `billing_merchant`
--
...
--
-- Estructura de tabla para la tabla `billing_paypal`
--
...
--
-- Volcar la base de datos para la tabla `billing_paypal`
--
...
--
-- Volcar la base de datos para la tabla `billing_plans`
--
...
(1, 'TTF-1Week-$10', '10010', 'PayPal', '604800', 'Time-To-Finish', '3', '', '', '', '', '', '', 'No', 'Never', 'Fixed', '10', '0', '0', 'USD', '', 'yes', '2011-06-18 16:49:12', 'administrator', '2011-06-18 16:49:51', 'administrator'),
(2, 'Acc-1Week-$12', '10020', 'PayPal', '604800', 'Accumulative', '3', '', '', '', '', '', '', 'No', 'Never', 'Fixed', '10', '2', '0', 'USD', '', 'yes', '2011-06-18 16:50:20', 'administrator', NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `billing_plans_profiles`
--
...
--
-- Volcar la base de datos para la tabla `billing_plans_profiles`
--

INSERT INTO `billing_plans_profiles` (`id`, `plan_name`, `profile_name`) VALUES
(2, 'TTF-1Week-$10', 'TimeToFinish-1Week'),
(3, 'Acc-1Week-$12', 'Accumulative-1Week');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `billing_rates`
--
...
--
-- Volcar la base de datos para la tabla `billing_rates`
--
...
--
-- Estructura de tabla para la tabla `cui`
--
...
--
-- Volcar la base de datos para la tabla `cui`
--
...
--
-- Volcar la base de datos para la tabla `dictionary`
--
...
(75, 'integer', 'Mikrotik-Recv-Limit', NULL, NULL, 'Mikrotik', '=', 'reply', 'bitspersecond', 'total receive limit in bytes for the client'),
(76, 'integer', 'Mikrotik-Xmit-Limit', NULL, NULL, 'Mikrotik', '=', 'reply', 'bitspersecond', 'total transmit limit in bytes for the client'),
...
(88, 'integer', 'Mikrotik-Recv-Limit-Gigawords', NULL, NULL, 'Mikrotik', '=', 'reply', 'bitspersecond', '4G (2^32) bytes of total receive limit (bits 32..63, when bits 0..31 are delivered in Mikrotik-Recv-Limit)'),
(89, 'integer', 'Mikrotik-Xmit-Limit-Gigawords', NULL, NULL, 'Mikrotik', '=', 'reply', 'bitspersecond', '4G (2^32) bytes of total transmit limit (bits 32..63, when bits 0..31 are delivered in Mikrotik-Recv-Limit)'),
...
--
-- Volcar la base de datos para la tabla `hotspots`
--
...
--
-- Volcar la base de datos para la tabla `invoice_items`
--
...
--
-- Volcar la base de datos para la tabla `invoice_status`
--
...
--
-- Volcar la base de datos para la tabla `invoice_type`
--
...
(1, 'localhost', 'localhost', 'other', 0, 'testing123', NULL, '', ''),
(2, '192.168.10.1', 'pfsense', '', 0, 'pfsense123', NULL, '', '');
...
--
-- Volcar la base de datos para la tabla `operators`
--
...
(6, 'administrator', 'radius', '', '', '', '', '', '', '', '', '', '', '', '', '2017-06-06 23:42:08', '2009-12-07 20:12:33', 'admin', '2009-12-07 20:14:01', 'administrator');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `operators_acl`
--
...
--
-- Volcar la base de datos para la tabla `operators_acl`
--
...
--
-- Estructura de tabla para la tabla `operators_acl_files`
--
...
--
-- Volcar la base de datos para la tabla `operators_acl_files`
--
...
--
-- Volcar la base de datos para la tabla `payment_type`
--
...
--
-- Volcar la base de datos para la tabla `proxys`
--
...
--
-- Volcar la base de datos para la tabla `radacct`
--
...
(1, '88549bbae336e2d3', '4899f73931b22cda', 'mjtamayo', '', '', '192.168.10.1', '2000', 'Ethernet', '2017-06-06 22:41:37', '2017-06-06 22:53:06', 688, 'RADIUS', '', '', 23465, 53974, '192.168.10.1', '00:0c:29:96:8e:90', 'User-Request', '', '', '172.80.1.100', 0, 0, ''),
(2, '90c4a0c59afa6ca0', '6f14116d4ae0ccd4', 'mjtamayo', '', '', '192.168.10.1', '2000', 'Ethernet', '2017-06-06 22:53:26', '2017-06-06 23:13:17', 1192, 'RADIUS', '', '', 21155, 172569, '192.168.10.1', '00:0c:29:96:8e:90', 'Idle-Timeout', '', '', '172.80.1.100', 0, 0, '');
...
--
-- Volcar la base de datos para la tabla `radcheck`
--

INSERT INTO `radcheck` (`id`, `username`, `attribute`, `op`, `value`) VALUES
(1, 'daloradius', 'Cleartext-Password', ':=', 'daloradius'),
(2, 'mjtamayo', 'Cleartext-Password', ':=', '123456');
...
--
-- Volcar la base de datos para la tabla `radgroupcheck`
--
...
(27, '25horas', 'Max-All-Session', ':=', '90000'),
(28, '25horas', 'Simultaneous-Use', ':=', '1');
...
--
-- Volcar la base de datos para la tabla `radgroupreply`
--
...
(11, '25horas', 'Acct-Interim-Interval', ':=', '60');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `radhuntgroup`
--
...
--
-- Volcar la base de datos para la tabla `radhuntgroup`
--
...
--
-- Estructura de tabla para la tabla `radippool`
--
...
--
-- Volcar la base de datos para la tabla `radippool`
--
...
--
-- Volcar la base de datos para la tabla `radpostauth`
--

INSERT INTO `radpostauth` (`id`, `username`, `pass`, `reply`, `authdate`) VALUES
(1, 'mjtamayo', '123456', 'Access-Accept', '2017-06-05 19:23:39'),
(2, '00:0c:29:96:8e:90', 'pfsense123', 'Access-Reject', '2017-06-06 22:41:18'),
(3, '00:0c:29:96:8e:90', 'pfsense123', 'Access-Reject', '2017-06-06 22:41:36'),
(4, 'mjtamayo', '123456', 'Access-Accept', '2017-06-06 22:41:37'),
(5, '00:0c:29:96:8e:90', 'pfsense123', 'Access-Reject', '2017-06-06 22:53:13'),
(6, '00:0c:29:96:8e:90', 'pfsense123', 'Access-Reject', '2017-06-06 22:53:25'),
(7, 'mjtamayo', '123456', 'Access-Accept', '2017-06-06 22:53:26'),
(8, '', '', 'Access-Reject', '2017-06-06 22:56:31');
...
--
-- Volcar la base de datos para la tabla `radreply`
--
...
--
-- Volcar la base de datos para la tabla `radusergroup`
--
...
--
-- Estructura de tabla para la tabla `realms`
--
...
--
-- Volcar la base de datos para la tabla `realms`
--
...
--
-- Estructura de tabla para la tabla `userbillinfo`
--
...
--
-- Volcar la base de datos para la tabla `userbillinfo`
--
...
(1, 'daloradius', '', NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', '', '', '', '', '0000-00-00', '0000-00-00', 0, 0, '', '', '', NULL, '2011-06-18 16:09:05', 'administrator', '2011-06-18 16:09:41', 'administrator'),
(2, 'mjtamayo', '', NULL, NULL, 'Miguel José Tamayo', '', 'mjtamayo@infomed.sld.cu', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '0', '', '', '', '', '0000-00-00', '0000-00-00', 0, 0, '', '', '', NULL, '2017-06-05 19:09:11', 'administrator', '2017-06-06 23:42:21', 'administrator');
...
--
-- Volcar la base de datos para la tabla `userinfo`
--
...
(1, 'daloradius', 'daloradius', '', '', '', '', '', '', '', '', '', '', '', '', 'test user', '1', 'daloradius', 1, '2011-06-18 16:09:05', 'administrator', '2011-06-18 16:09:41', 'administrator'),
(2, 'mjtamayo', 'Miguel José', 'Tamayo', 'mjtamayo@infomed.sld.cu', '', '', '', '', '', '', '', '', '', '', '', '1', 'mjtamayo', 1, '2017-06-05 19:09:11', 'administrator', '2017-06-06 23:42:21', 'administrator');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `wimax`
--
...
--
-- Volcar la base de datos para la tabla `wimax`
--
